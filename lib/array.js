  ...
  function buildEnhancedMap() {
    ...
    var fn = function(arr, f, context) {
      return callNativeMapWithTransform(nativeFn, arr, f, context);
    }
    // Manually building instance to maintain function length dictated by the ES5 spec.
    fn.instance = function(f) {
      // Force compiler to respect argument length.
      var argLen = arguments.length, context = arguments[1];
      return callNativeMapWithTransform(nativeFn, this, f, context);
    }
    defineInstance(sugarArray, {'map': fn}, [ENHANCEMENTS_FLAG, ARRAY_ENHANCEMENTS_FLAG]);
  }
